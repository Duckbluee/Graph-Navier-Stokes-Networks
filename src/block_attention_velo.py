...
class AttODEblock(ODEblock):
  def __init__(self, odefunc, regularization_fns, opt, data, device, node_t, t=torch.tensor([0, 1]), gamma=0.5):
    super(AttODEblock, self).__init__(odefunc, regularization_fns, opt, data, device, t, node_t)
