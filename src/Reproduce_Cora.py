...
from Cora_params import best_params_dict, hetero_params, shared_gnsn_params, shared_grand_params
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_best_params', default=True, help="flag to take the best param")
